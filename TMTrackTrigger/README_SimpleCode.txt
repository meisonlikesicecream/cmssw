...
specifiied in TMTrackTrigger/TMTrackFinder/python/TMTrackProducer_Defaults_cfi.py. 

b) The file mentioned on (a) is imported by
TMTrackTrigger/TMTrackFinder/python/TMTrackProducer_cff.py ,
...
c) Alternatively, you can use TMTrackTrigger/TMTrackFinder/python/TMTrackProducer_Ultimate_cff.py ,
