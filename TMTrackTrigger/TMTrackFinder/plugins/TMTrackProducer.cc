#include <TMTrackTrigger/TMTrackFinder/plugins/TMTrackProducer.h>
...
#include "TMTrackTrigger/TMTrackFinder/interface/MiniHTstage.h"
#include "TMTrackTrigger/TMTrackFinder/interface/StubWindowSuggest.h"
