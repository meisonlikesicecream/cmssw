...
Phase1L1TSumsProducer9x9trimmed = Phase1L1TSumsProducer.clone(
  jetCollectionTag = cms.InputTag("Phase1L1TJetCalibrator9x9trimmed", "Phase1L1TJetFromPfCandidates"),
)

Phase1L1TJetsSequence9x9trimmed = cms.Sequence(
  Phase1L1TJetProducer9x9trimmed +
  Phase1L1TJetCalibrator9x9trimmed + 
  Phase1L1TSumsProducer9x9trimmed
)