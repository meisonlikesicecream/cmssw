...
# defaults
options.inputFiles = '/store/mc/Phase2HLTTDRWinter20DIGI/TTToSemiLepton_TuneCP5_14TeV-powheg-pythia8/GEN-SIM-DIGI-RAW/PU200_110X_mcRun4_realistic_v3-v2/50000/00850711-FB6B-E04A-A51A-C9C1F699E2F0.root'
options.outputFile = 'file:out.root'
...
process.l1pfProducerBarrel.trkPtCut = trackPtCut
process.l1pfProducerHGCal.trkPtCut = trackPtCut
process.l1pfProducerHF.trkPtCut = trackPtCut

process.L1TkPrimaryVertex.PTMINTRA = trackPtCut
