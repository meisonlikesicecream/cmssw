...
SiStripSimBlock = cms.PSet(
    ...
    apvBaselinesFile_tib1      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TIB1_10us.txt'),
    apvBaselinesFile_tib2      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TIB2_10us.txt'),
    apvBaselinesFile_tib3      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TIB3_10us.txt'),
    apvBaselinesFile_tib4      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TIB4_10us.txt'),
    apvBaselinesFile_tob1      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB1_10us.txt'),
    apvBaselinesFile_tob2      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB2_10us.txt'),
    apvBaselinesFile_tob3      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB3_10us.txt'),
    apvBaselinesFile_tob4      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB4_10us.txt'),
    apvBaselinesFile_tob5      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB5_10us.txt'),
    apvBaselinesFile_tob6      = cms.FileInPath('SimTracker/SiStripDigitizer/data/APVBaselines_TOB6_10us.txt')
)
